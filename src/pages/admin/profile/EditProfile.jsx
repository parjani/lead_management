  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-end gap-4">
        ...
        <button className="px-6 py-3 rounded-xl bg-blue-600 hover:bg-blue-700 text-white flex items-center gap-2 transition cursor-pointer">
